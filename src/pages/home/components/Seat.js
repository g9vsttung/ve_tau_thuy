        ...
        if (this.props.description === true) {
            ...
            if (this.props.status === "unavailable")
                ...
                return (
                    ...
                    <div className='child' onClick={() => this.props.onSelectedSeat(this.props.id, this.props.name)} style={{ justifyContent: "center", display: "flex", alignItems: "center", width: "8%", border: "1px groove grey", borderBottom: "7px solid black", borderTopLeftRadius: "15px", borderTopRightRadius: "15px", backgroundColor: this.props.status === "available" ? "rgba(0, 0, 0, 0.11)" : "rgba(183, 247, 190, 0.8)" }}>
                        <p style={{ fontSize: "smaller", margin: "5px", fontWeight: "bold" }}>{this.props.name}</p>
                    </div>
                );
