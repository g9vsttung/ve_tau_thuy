            ...
            if (this.props.listSeat.length === 0) {
                ...
                const elements = this.props.listSeat.map((e) => {
                    if (e.status === "unavailabe")
                        ...
                        return <Seat key={e.name} name={e.name} status={e.status} onSelectedSeat={this.props.onSelectedSeat} />
                }
                            ...
                            <div style={{ width: "100%" }}>
                                <Row style={{ padding: "15px" }}>
                                    ...
                                    <Col>
                                        ...
                                        <button style={{ float: "right", clear: "both", fontSize: "20px" }} type="button" class="btn btn-primary" >Thanh toán</button>
                                    </Col>
                                </Row>
                            </div>
                        </div>
